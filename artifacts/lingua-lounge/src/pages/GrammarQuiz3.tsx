...
import { buildGrammarQuiz3, GRAMMAR3_QUIZ_SIZE, type GrammarQuestion } from "@/data/grammar3";
...
export default function GrammarQuiz3({ onBack }: Props) {
  const [questions, setQuestions] = useState<GrammarQuestion[]>(() => buildGrammarQuiz3());
  ...
  const handleRestart = useCallback(() => {
    setQuestions(buildGrammarQuiz3());
    setIndex(0);
    setStatus("idle");
    setChosen(null);
      ...
      <div className="screen">
        <div className="card results-card">
          ...
          <div className="score-ring">
            ...
            <span className="score-denom">/ {GRAMMAR3_QUIZ_SIZE}</span>
          </div>
