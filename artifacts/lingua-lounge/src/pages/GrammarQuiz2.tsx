...
import { buildGrammarQuiz2, GRAMMAR2_QUIZ_SIZE, type GrammarQuestion } from "@/data/grammar2";
...
export default function GrammarQuiz2({ onBack }: Props) {
  const [questions, setQuestions] = useState<GrammarQuestion[]>(() => buildGrammarQuiz2());
  ...
  const handleRestart = useCallback(() => {
    setQuestions(buildGrammarQuiz2());
    setIndex(0);
    setStatus("idle");
    setChosen(null);
      ...
      <div className="screen">
        <div className="card results-card">
          ...
          <div className="score-ring">
            ...
            <span className="score-denom">/ {GRAMMAR2_QUIZ_SIZE}</span>
          </div>
