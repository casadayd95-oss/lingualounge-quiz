...
function buildModulePracticeReviewQuiz(moduleNumber: number): ModuleReviewPracticeQuestion[] {
  const bank = moduleNumber === 3 ? module3ReviewBank : moduleNumber === 2 ? module2ReviewBank : module1ReviewBank;
...
export function buildModuleReviewQuiz(moduleNumber: number): ModuleReviewQuestion[] {
  if (moduleNumber === 1 || moduleNumber === 2 || moduleNumber === 3) return buildModulePracticeReviewQuiz(moduleNumber);
